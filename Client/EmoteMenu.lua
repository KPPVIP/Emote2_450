...
function AddInfoMenu(menu)
    if not UpdateAvailable then
     infomenu = _menuPool:AddSubMenu(menu, Config.Languages[lang]['infoupdate'], "(V2.0)", "", Menuthing, Menuthing)
    else
    ...
    u151 = NativeUI.CreateItem("v2.0", "Added 24+ extra animations | AdminPlus#0001 ~g~v2.0")
    u150 = NativeUI.CreateItem("V1.0", "Added 24+ animations | DimeloEli#6881 ~o~v1.0")
