...
DP.Dances = {
   ...
   ["dancesalsa"] = {"anim@mp_player_intcelebrationmale@salsa_roll", "salsa_roll", "Dance Salsa ~g~v2.0", AnimationOptions =
   {
       EmoteMoving = true,
   }},
...
DP.Emotes = {
   ["gangsign3"] = {"amb@code_human_in_car_mp_actions@gang_sign_a@bodhi@rds@base", "idle_a", "Gang Sign 3 ~o~v1.0", AnimationOptions =
   {
       EmoteLoop = true,
       EmoteMoving = true,
   }},
   ["gangsign4"] = {"amb@code_human_in_car_mp_actions@gang_sign_a@bodhi@rps@base", "idle_a", "Gang Sign 4 ~o~v1.0", AnimationOptions =
   {
       EmoteLoop = true,
       EmoteMoving = true,
   }},
   ["gangsign5"] = {"amb@code_human_in_car_mp_actions@gang_sign_a@low@ds@base", "idle_a", "Gang Sign 5 ~o~v1.0", AnimationOptions =
   {
       EmoteLoop = true,
       EmoteMoving = true,
   }},
   ["gangsign6"] = {"amb@code_human_in_car_mp_actions@gang_sign_a@std@rps@base", "idle_a", "Gang Sign 6 ~o~v1.0", AnimationOptions =
   {
       EmoteLoop = true,
       EmoteMoving = true,
   }},
   ["gangsign7"] = {"amb@code_human_in_car_mp_actions@gang_sign_b@low@ps@base", "idle_a", "Gang Sign 7 ~o~v1.0", AnimationOptions =
   {
       EmoteLoop = true,
       EmoteMoving = true,
   }},
   ["westside"] = {"amb@code_human_in_car_mp_actions@gang_sign_a@std@ds@base", "idle_a", "West Side ~o~v1.0", AnimationOptions =
   {
       EmoteLoop = true,
       EmoteMoving = true,
   }},
   ["hoover"] = {"amb@code_human_in_car_mp_actions@gang_sign_a@std@rds@base", "idle_a", "W/S Hoover ~o~v1.0", AnimationOptions =
   {
       EmoteLoop = true,
       EmoteMoving = true,
   }},
   ["neighbors"] = {"amb@code_human_in_car_mp_actions@gang_sign_b@std@ds@base", "idle_a", "Neighborhood Crip ~o~v1.0", AnimationOptions =
   {
       EmoteLoop = true,
       EmoteMoving = true,
   }},
   ["ms13"] = {"amb@code_human_in_car_mp_actions@gang_sign_b@std@rps@base", "idle_a", "MS-13 ~o~v1.0", AnimationOptions =
   {
       EmoteLoop = true,
       EmoteMoving = true,
   }},
   ["interested"] = {"anim@amb@casino@bar@special_peds@lauren@01a@base@", "base_lauren", "Interested ~o~v1.0", AnimationOptions =
   {
       EmoteLoop = true,
       EmoteMoving = true,
   }},
   ["wait14"] = {"anim@amb@casino@hangout@ped_male@stand@01a@base", "base", "Wait 14 ~o~v1.0", AnimationOptions =
   {
       EmoteLoop = true,
       EmoteMoving = true, 
   }},
   ["wait15"] = {"anim@amb@carmeet@checkout_car@female_a@base", "base", "Wait 15 ~o~v1.0", AnimationOptions =
   {
       EmoteLoop = true,
       EmoteMoving = true, 
   }},
   ["wait16"] = {"anim@amb@carmeet@checkout_car@male_a@base", "base", "Wait 16 ~o~v1.0", AnimationOptions =
   {
       EmoteLoop = true,
       EmoteMoving = true, 
   }},
   ["wait17"] = {"anim@amb@carmeet@checkout_engine@female_a@base", "base", "Wait 17 ~o~v1.0", AnimationOptions =
   {
       EmoteLoop = true,
       EmoteMoving = true, 
   }},
   ["wavehigh"] = {"anim@amb@waving@male", "ground_wave", "Wave High ~o~v1.0", AnimationOptions =
   {
       EmoteLoop = true,
       EmoteMoving = true, 
   }},
   ["wavehigh2"] = {"anim@amb@waving@female", "ground_wave", "Wave High 2 ~o~v1.0", AnimationOptions =
   {
       EmoteLoop = true,
       EmoteMoving = true, 
   }},
   ["wavehigh3"] = {"anim@amb@waving@male", "air_wave", "Wave High 3 ~o~v1.0", AnimationOptions =
   {
       EmoteLoop = true,
       EmoteMoving = true, 
   }},
   ["wavehigh4"] = {"anim@amb@waving@female", "air_wave", "Wave High 4 ~o~v1.0", AnimationOptions =
   {
       EmoteLoop = true,
       EmoteMoving = true, 
   }},
   ["searchground"] = {"anim@amb@carmeet@checkout_engine@male_a@base", "base", "Search Ground ~o~v1.0", AnimationOptions =
   {
       EmoteLoop = true,
       EmoteMoving = true, 
   }},
   ...
   ["dab"] = {"custom@dab", "dab", "Dab ~o~v1.0", AnimationOptions =
   {
       EmoteMoving = true,
       EmoteDuration = 2500,
   }},
   ...
   ["aim"] = {"arrest", "base", "Aim ~o~v1.0", AnimationOptions =
   {
       EmoteDuration = 5000,
   }},
   ...
   ------------------------------------------------------------------------------------------
   ------------------------------------------------------------------------------------------
   ["taunt"] = {"switch@franklin@gang_taunt_p1", "gang_taunt_loop_thug_01", "Taunt ~g~v2.0", AnimationOptions =
   {
       EmoteLoop = true,
       EmoteMoving = true,
   }},
   ["taunt2"] = {"switch@franklin@gang_taunt_p1", "gang_taunt_loop_thug_02", "Taunt 2 ~g~v2.0", AnimationOptions =
   {
       EmoteLoop = true,
       EmoteMoving = false,
   }},
   ["taunt3"] = {"switch@franklin@gang_taunt_p1", "gang_taunt_loop_lamar", "Taunt 3 ~g~v2.0", AnimationOptions =
   {
       EmoteLoop = false,
       EmoteMoving = true,
   }},
   ["taunt4"] = {"switch@franklin@gang_taunt_p3", "gang_taunt_with_lamar_loop_g2", "Taunt 4 ~g~v2.0", AnimationOptions =
   {
       EmoteLoop = true,
       EmoteMoving = true,
   }},
   ["taunt5"] = {"switch@franklin@gang_taunt_p3", "gang_taunt_with_lamar_loop_g1", "Taunt 5 ~g~v2.0", AnimationOptions =
   {
       EmoteMoving = true,
   }},
   ["taunt6"] = {"switch@franklin@gang_taunt_p5", "fras_ig_6_p5_loop_g1", "Taunt 6 ~g~v2.0", AnimationOptions =
   {
	   EmoteLoop = true,
       EmoteMoving = false,
   }},
   ["taunt7"] = {"anim@mp_player_intcelebrationmale@cry_baby", "cry_baby", "Taunt 7 - Crying ~g~v2.0", AnimationOptions =
   {
	   EmoteLoop = true,
   }},
   ["holdback"] = {"switch@franklin@gang_taunt_p1", "gang_taunt_loop_franklin", "Hold Back ~g~v2.0", AnimationOptions =
   {
       EmoteLoop = true,
       EmoteMoving = false,
   }},
   ["holdback2"] = {"switch@franklin@gang_taunt_p5", "fras_ig_6_p5_loop_frank", "Hold Back 2 ~g~v2.0", AnimationOptions =
   {
	   EmoteLoop = true,
       EmoteMoving = true,
   }},
   ["crossarms7"] = {"switch@franklin@gang_taunt_p5", "fras_ig_6_p5_loop_g2", "Crossarms 7 ~g~v2.0", AnimationOptions =
   {
	   EmoteLoop = true,
       EmoteMoving = true,
   }},
   ["peace3"] = {"anim@mp_player_intcelebrationfemale@v_sign", "v_sign", "Peace 3 ~g~v2.0", AnimationOptions =
   {
	   EmoteLoop = true,
       EmoteMoving = true,
   }},
   ["peace4"] = {"anim@mp_player_intincarv_signbodhi@ds@", "idle_a", "Peace 4 ~g~v2.0", AnimationOptions =
   {
       EmoteMoving = true,
   }},
   ["nosepick2"] = {"anim@mp_player_intcelebrationmale@nose_pick", "nose_pick", "Nose Pick 2 ~g~v2.0", AnimationOptions =
   {
       EmoteMoving = true,
   }},
   ["peace5"] = {"anim@mp_player_intincarv_signbodhi@ps@", "idle_a", "Peace 5 ~g~v2.0", AnimationOptions =
   {
       EmoteMoving = true,
   }},
   ["peace6"] = {"mp_player_int_upperv_sign", "mp_player_int_v_sign", "Peace 6 ~g~v2.0", AnimationOptions =
   {
       EmoteMoving = true,
   }},
   ------------------------------------------------------------------------------------------
   ...
   ["boi"] = {"special_ped@jane@monologue_5@monologue_5c", "brotheradrianhasshown_2", "BOI ~o~v1.0", AnimationOptions =
   {
      EmoteMoving = true,
      EmoteDuration = 3000,
   }},
...
DP.PropEmotes = {
   ["candy"] = {"anim@move_f@waitress", "idle", "Candy ~g~v2.0", AnimationOptions =
   {
       Prop = "prop_candy_pqs",
       PropBone = 57005,
   ...
   ["waitress"] = {"anim@move_f@waitress", "idle", "Waitress ~o~v1.0", AnimationOptions =
   {
   ...
   ["waitress2"] = {"anim@move_f@waitress", "idle", "Waitress 2 ~o~v1.0", AnimationOptions =
   {
...
-----------------------------------------------------------------------------------------------------
   ...
   ["beg"] = {"amb@world_human_bum_freeway@male@base", "base", "Beg ~g~v2.0", AnimationOptions =
   {
   ...
   ["teddy2"] = {"impexp_int-0", "mp_m_waremech_01_dual-0", "Teddy 2 ~g~v2.0", AnimationOptions =
   {
       Prop = 'v_club_vu_bear',
       PropBone = 24817,
       PropPlacement = {-0.20, 0.46, -0.016, -180.0, -90.0, 0.0},
   ...
   ["pizza"] = {"anim@move_f@waitress", "idle", "Pizza ~g~v2.0", AnimationOptions =
   {
   ...
   ["shopping"] = {"missheistdocksprep1hold_cellphone", "static", "Shopping ~g~v2.0", AnimationOptions =
   {
   ...
   ["shopping2"] = {"missheistdocksprep1hold_cellphone", "static", "Shopping 2 ~g~v2.0", AnimationOptions =
   {
   ...
   ["guitarelectric3"] = {"amb@world_human_musician@guitar@male@idle_a", "idle_b", "Guitar Electric 3 ~g~v2.0", AnimationOptions =
   {
   ...
   ["microphone"] = {"anim@heists@humane_labs@finale@keycards", "ped_a_enter_loop", "Microphone ~g~v2.0", AnimationOptions =
   {
